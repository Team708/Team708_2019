...
public Climber() {
	...
	public void sendToDashboard() {
		...
		SmartDashboard.putBoolean("Front Extend", ExtendFront());
		SmartDashboard.putBoolean("Front Retract", RetractFront());
		SmartDashboard.putBoolean("Rear Extend",  ExtendRear());
		SmartDashboard.putBoolean("Rear Retract",  RetractRear());	
