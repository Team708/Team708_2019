...
public final class Constants {
	...
	public static final double 	CLIMBER_ROLLER_FORWARD				=  0.2;	// 0.6	
	public static final double 	CLIMBER_ROLLER_BACKWARD				=  -0.2;	// -0.6	

	public static final int		MOVE_CLIMBER_FORWARD				=  18;
	public static final double	MOVE_CLIMBER_TOLERANCE				=  .5;
	public static final double	MOVE_CLIMBER_EXTEND					=  -0.2; // -1.0
	public static final double	MOVE_CLIMBER_RETRACT				=  0.2;  // 1.0
